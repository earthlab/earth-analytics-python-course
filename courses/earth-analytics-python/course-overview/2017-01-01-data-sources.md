...
permalink: /courses/earth-analytics-python/data-sources/
...
| <a href="https://search.earthdata.nasa.gov/search" target="_blank">NASA Earthdata Search</a>| Lots of different NASA datasets; has some overlap with Earth Explorer. Used to be Nasa Reverb|
...
| <a href="http://nadp.slh.wisc.edu/" target="_blank">NADP (National Atmospheric Deposition Program)</a> | The National Trends Network has weekly precipitation chemistry data, along with some basic meteorology (daily precip, phase, and perhaps temp) at a number of sites across the country. |
